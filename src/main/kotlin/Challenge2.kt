...
class Wizard(var firstName: String, var lastName: String) {
    var fullName: String
        ...
        set(input) {
            val fullNameSplit = input.split(" ")
            if (fullNameSplit.size != 2) {
    ...
    companion object {
        var commonMagicalIngredients = mutableListOf("Wand", "Potion", "Magic")
    }
}
...
fun main() {
    ...
    Wizard.commonMagicalIngredients.add("Spell")
